...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="register-header mt-3">{{ __('Register') }}</div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-8 offset-md-2">
                                ...
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" placeholder="Enter Confirm Password" autocomplete="password">
                            </div>
                        </div>

                        <div class="form-group row mb-0\">
                            <div class="col-md-8 offset-md-2 mt-3 ">
                                <button type="submit" class="btn register-button-style">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
